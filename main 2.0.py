...
tokenized_objects =     list(map(lambda text: tokenizer.Tokenizer(text),raw_text))
...
primary_corpus = concept_corpus.Concept_Corpus(nounset_list)
secodary_corpus = mini_corpus.Mini_Corpus(primary_corpus.doc_data,noun_indices)
semantic_evaluation = sem_eval.Sem_Eval(secodary_corpus.query_data,token_data)
