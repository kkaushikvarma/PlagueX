...
class Gui:
    ...
    def page3(self):
        ...
        def hood():
            ...
            button2 = Button(data_frame, text = "Classifier Results", width = 20, bg = "#c0392b", fg = "#ecf0f1", font = ("Helvetica 12 bold") , pady = 8, command = classifier)
            semframe = Frame(data_frame, bg = "#ecf0f1")
            semframe.pack(side = "top")
            path_frame = Frame(semframe, bg = "#ecf0f1")
            lch_frame = Frame(semframe, bg = "#ecf0f1", relief = "groove")
            wup_frame = Frame(semframe, bg = "#ecf0f1")
            path_frame.pack(side = "left", pady = 8, padx = 8)
            lch_frame.pack(side = "left", pady = 8, padx = 8)
            wup_frame.pack(side = "left", pady = 8, padx = 8)
